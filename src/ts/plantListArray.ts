...
export let plantList:Array <Plant> = [new Plant (1, false, monsteraURL, "Monstera deliciosa", "Monstera", 159, 
    ...
    new Plant (1, false, alokasiaURL, "Alocasia macrorrhizos", "Alokasia",
    ...
    new Plant (1, false, zamiakallaURL, "Zamioculcas zamiifolia", "Zamiakalla", 299, 
    ...
    new Plant (1, false, fredskallaURL, "Spathiphyllum spp. 'Strauss'","Fredskalla",
    149,
    ...
    new Plant (1, false, julstjarnaURL,"", "Julstjärna", 
    299, 
    ...
    "Vattna med jämna mellanrum och undvik direkt solljus", "Undvik direktsol",
     ...
     new Plant (1, false, alaskastjarnaURL,"", "Alaskastjärna", 
     349, 
     "Trivs på ljus plats, men skuggas i söder. Känslig för kyla och drag, kan tappa bladen om det är för kallt. Optimal temperatur är mellan 15-22 grader. Jämn vattning, inte för blött och inte för torrt. Grenad planta. Växtsaften kan ge hudretning.", 
     6, 
     "Vattna med jämna mellanrum och undvik direkt solljus", "Undvik direktsol",
      ...
      new Plant (1, false, hostbegoniaURL,"", "Höstbegonia", 
      349, 
      "Trivs på ljus plats, men skuggas i söder. Känslig för kyla och drag, kan tappa bladen om det är för kallt. Optimal temperatur är mellan 15-22 grader. Jämn vattning, inte för blött och inte för torrt. Grenad planta. Växtsaften kan ge hudretning.", 
      7, 
      "Vattna med jämna mellanrum och undvik direkt solljus", "Undvik direktsol",
       ...
       new Plant (1, false, brudorkideURL,"", "Brudorkidé", 
       349, 
       "Trivs på ljus plats, men skuggas i söder. Känslig för kyla och drag, kan tappa bladen om det är för kallt. Optimal temperatur är mellan 15-22 grader. Jämn vattning, inte för blött och inte för torrt. Grenad planta. Växtsaften kan ge hudretning.", 
       7, 
       "Vattna med jämna mellanrum och undvik direkt solljus", "Undvik direktsol",
